...
let btnId="menu-btn-" + target;
let btnTextId="menu-btn-text-" + target;
let btnClass="menu-btn-" + target + ' btn';
let btnTextClass="menu-btn-text-" + target;

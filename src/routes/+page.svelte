...
<div class="mx-auto max-w-2xl">
  <div class="flex flex-col p-10 gap-10 items-start bg-gray-1000 border-[0.5px] border-gray-700 rounded-3xl">
    <div class="flex flex-col gap-10">
      ...
      <div>
        <a href="/start" class="inline-flex items-center gap-x-1.5 rounded-md bg-primary-01 px-4 py-2 font-normal text-black rounded-xl border border-primary-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500/50" role="button">
          Launch app

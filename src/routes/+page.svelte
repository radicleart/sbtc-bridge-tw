...
<div class="container">
    <div class="frame14">
        ...
        <div class="frame26">
                ...
                <p class="text-hint">
                    In order to interact with this application, you will need to have a wallet that supports both BTC and STX. <a class="text-hint-link" href="/wallet">Don’t have a wallet?</a>
                </p>
                <p class="text-hint">
